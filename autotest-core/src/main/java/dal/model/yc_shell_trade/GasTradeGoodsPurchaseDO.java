...
@Table(name = "gas_trade_goods_purchase")
public class GasTradeGoodsPurchaseDO implements Serializable {
    /**
     * 自增序列
     */
    @Id
    ...
    public boolean equals(Object that) {
        ...
        GasTradeGoodsPurchaseDO other = (GasTradeGoodsPurchaseDO) that;
