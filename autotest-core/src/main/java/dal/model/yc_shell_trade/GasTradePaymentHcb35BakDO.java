...
@Table(name = "gas_trade_payment_hcb35_bak")
public class GasTradePaymentHcb35BakDO implements Serializable {
    /**
     * 自增序列
     */
    @Id
    ...
    public boolean equals(Object that) {
        ...
        GasTradePaymentHcb35BakDO other = (GasTradePaymentHcb35BakDO) that;
