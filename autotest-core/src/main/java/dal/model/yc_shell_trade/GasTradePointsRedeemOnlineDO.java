...
@Table(name = "gas_trade_points_redeem_online")
public class GasTradePointsRedeemOnlineDO implements Serializable {
    /**
     * 自增序列
     */
    @Id
    ...
    public boolean equals(Object that) {
        ...
        GasTradePointsRedeemOnlineDO other = (GasTradePointsRedeemOnlineDO) that;
