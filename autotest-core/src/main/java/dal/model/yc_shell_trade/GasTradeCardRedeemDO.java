...
@Table(name = "gas_trade_card_redeem")
public class GasTradeCardRedeemDO implements Serializable {
    /**
     * 自增序列
     */
    @Id
     ...
     * 获取渠道用户姓名
     *
     * @return channel_user_name - 渠道用户姓名
     */
    ...
    public boolean equals(Object that) {
        ...
        GasTradeCardRedeemDO other = (GasTradeCardRedeemDO) that;
