...
@Table(name = "luck_draw_campaign")
public class LuckDrawCampaignDO implements Serializable {
    /**
     * 主键id
     */
    @Id
    ...
    public String toString() {
        ...
        sb.append(", calRateWay=").append(calRateWay);
    ...
    public boolean equals(Object that) {
        ...
        LuckDrawCampaignDO other = (LuckDrawCampaignDO) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getCalRateWay() == null ? other.getCalRateWay() == null : this.getCalRateWay().equals(other.getCalRateWay()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getCalRateWay() == null) ? 0 : getCalRateWay().hashCode());
