...
public class GiveLuckDrawDetailDO implements Serializable {
     ...
     * 赠送的抽奖次数信息
     */
    @Column(name = "give_draws")
    private String giveDraws;
     ...
     * 获取赠送的抽奖次数信息
     *
     * @return give_draws - 赠送的抽奖次数信息
     */
    public String getGiveDraws() {
        return giveDraws;
    }
     ...
     * 设置赠送的抽奖次数信息
     *
     * @param giveDraws 赠送的抽奖次数信息
     */
    public void setGiveDraws(String giveDraws) {
        this.giveDraws = giveDraws == null ? null : giveDraws.trim();
    }
    ...
    public String toString() {
        ...
        sb.append(", giveDraws=").append(giveDraws);
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getGiveDraws() == null ? other.getGiveDraws() == null : this.getGiveDraws().equals(other.getGiveDraws()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getGiveDraws() == null) ? 0 : getGiveDraws().hashCode());
