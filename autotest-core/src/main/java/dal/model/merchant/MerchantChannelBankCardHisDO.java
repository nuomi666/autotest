...
@Table(name = "merchant_channel_bank_card_his")
public class MerchantChannelBankCardHisDO implements Serializable {
    @Id
    ...
    public boolean equals(Object that) {
        ...
        MerchantChannelBankCardHisDO other = (MerchantChannelBankCardHisDO) that;
