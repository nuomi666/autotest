 ...
 */
public class MallExchangeGoodsServicePageQueryMallExchangeGoodsWebTest extends SpringBootTestBase {
     ...
     */
    @AutoTest(file = "gas_merchant/mallExchangeGoodsServicePageQueryMallExchangeGoodsWebTestSuccess.csv")
    @DisplayName("商户平台分页查询积分商城商品--成功用例")
    public void mallExchangeGoodsServicePageQueryMallExchangeGoodsWebTestSuccess(
            // 基本参数
            int testId,
            Status status,
            String code,
        ...
        // 测试过程
        // 调用接口
        PagedResult<MallExchangeGoodsInfo> result = mallExchangeGoodsService.pageQueryMallExchangeGoodsWeb(order);
        // 结果验证
        print(result);
...
//        assertEquals(code, result.getCode());
        ...
        if (testId == 1001) {
            ...
            goodsInfoAssert(goodsInfos.get(0), goodsId, order.getPlatPartnerId(),
                    ...
                    exchangedCount2, null, null, null, null, null,
            ...
            goodsInfoAssert(goodsInfos.get(2), couponId1, order.getPlatPartnerId(),
                    ...
                    exchangedCount1, null, null, "5.00",
                    com.xyb.gas.merchant.api.enums.CouponBizType.GAS_COUPON,
                    com.xyb.gas.merchant.api.enums.CouponType.INSTANT,
        ...
        if (testId == 1004) {
            goodsInfoAssert(goodsInfos.get(1), goodsId1, order.getPlatPartnerId(),
                    ExchangeType.ENTITY.code(),
                    goodsName1, GainStyle.SELF.code(), goodsImg3, goodsDec, oneExchangeTimes3, storeNum3,
                    exchangePoint3,
                    exchangedCount3, null, null, null, null, null,
                    GoodsStatus.UNSALE, forSaleTime, invalidTime);
        }
        if (testId == 1005) {
            goodsInfoAssert(goodsInfos.get(1), goodsId1, order.getPlatPartnerId(),
                    ExchangeType.ENTITY.code(),
                    ...
                    exchangePoint3,
                    exchangedCount3, null, null, null, null, null,
                    GoodsStatus.SALE, invalidTime1, invalidTime2);
        }
        // 清除数据
        gasMerchantTestBase.cleanGasMallExchangeGoodsByPlatPartnerId(order.getPlatPartnerId());
        gasMerchantTestBase.cleanGasMallExchangeGoodsByPlatPartnerId(platPartnerId);
     ...
     *
     */
    @AutoTest(file = "gas_merchant/mallExchangeGoodsServicePageQueryMallExchangeGoodsWebTestFailOne.csv")
    @DisplayName("商户平台分页查询积分商城商品--参数非法")
    public void mallExchangeGoodsServicePageQueryMallExchangeGoodsWebTestFailOne(
            // 基本参数
            int testId,
            Status status,
            String code,
